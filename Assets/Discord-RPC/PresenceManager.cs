...
namespace DiscordPresence
{
    ...
    public class PresenceManager : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            if(rpcStringOutput == "Level 1")
            {
                DiscordRpc.UpdatePresence(instance.presence);
            }

            if(rpcStringOutput == "Main Menu")
            {
                DiscordRpc.UpdatePresence(instance.presence);
            }
        }
        ...
        {
            string rpcStringOutput = SceneManager.GetActiveScene().name;
            print("rpcstringoutput is now " + rpcStringOutput);
            string detailsNew = "In " + rpcStringOutput;
            print("detailsnew is now " + detailsNew);
            ...
            instance.presence.largeImageKey = "bean";
